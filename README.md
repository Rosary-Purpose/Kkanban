...
- **Cards** — titles, emoji icons, custom colors, due dates (with optional time), completion state
...
- **Backend:** Rust via [Tauri v2](https://tauri.app/), used for local file-based persistence (board data + background images)
